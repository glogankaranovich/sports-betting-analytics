...
class ModelFactory:
    ...
    def create_model(cls, model_name: str) -> BaseAnalysisModel:
        ...
        if model_name not in cls._models:
            raise ValueError(
                f"Unknown model: {model_name}. Available: {list(cls._models.keys()) + ['player_stats', 'fundamentals', 'matchup', 'momentum', 'value', 'hot_cold']}"
            )
    ...
    def get_available_models(cls) -> List[str]:
        ...
        return list(cls._models.keys()) + ["player_stats", "fundamentals", "matchup", "momentum", "value", "hot_cold"]
